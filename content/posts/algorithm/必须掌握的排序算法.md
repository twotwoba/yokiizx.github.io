...
分治思想，三路快排应用了荷兰国旗问题的 partition 分区方法。
...
注意，在归并排序之前的排序方法都是在原数组基础上进行的，上方是返回的新数组，下方是原数组修改的版本。
...
public static void mergeSort(int[] arr, int left, int right) {
    ...
    // 细节，这里区间分配是 [l...mid] 和 [mid + 1, r]，【l..mid-1】【mid, r】 会产生死循环
...
public static void shiftDown(int[] arr, int index, int heapSize) {
    ...
    while (left < heapSize) {  // 证明存在子节点
        ...
        // 注意，由于left + 1 < heapSize && ，后边不能写成 arr[left] < arr[left+1]? left: left+1
